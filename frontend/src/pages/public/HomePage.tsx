    ...
    <>
      ...
      <section className="bg-white border-b border-stone-200">
        <div className="max-w-6xl mx-auto px-4 py-16 md:py-24 text-center">
          <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold tracking-tight text-stone-900 mb-6">
            Thoughts on{' '}
            <span className="text-stone-500">code, design,</span>
            <br />
            <span className="text-stone-500">and life</span>
          </h1>
          <p className="text-base sm:text-lg text-stone-500 max-w-xl mx-auto mb-8 px-4">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-4">
            <Link
              to="/blog"
              className="inline-flex items-center gap-2 px-6 py-3 bg-stone-900 text-white rounded-lg font-medium hover:bg-stone-800 transition-colors w-full sm:w-auto justify-center"
            >
      ...
      {/* Latest Posts — responsive 2-row grid */}
      <section className="max-w-6xl mx-auto px-4 py-12 md:py-20">
        <div className="flex items-center justify-between mb-8 md:mb-10">
          <h2 className="text-xl sm:text-2xl font-bold text-stone-900">Latest posts</h2>
